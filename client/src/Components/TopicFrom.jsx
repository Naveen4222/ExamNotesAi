  ...
  return (
    <motion.div
      ...
      <input type="text" className='w-full p-3 rounded-xl
          ...
          text-white
          focus:outline-none focus:ring-2 focus:ring/white/30'
        placeholder='Enter class level(e.g.class 12)'
      ...
      <input type="text" className='w-full p-3 rounded-xl
          ...
          text-white
          focus:outline-none focus:ring-2 focus:ring/white/30'
        placeholder='Enter exam type(CBSE, JEE, NEET)'
        onChange={(e) => setExamType(e.target.value)}
        value={examType} />

      <div className='flex flex-col md:flex-row gap-6'>
        <Toggle lable="Exam Revision Mode" checked={revisionMode} onChange={() => setRevisionMode(!revisionMode)} />
        <Toggle lable="Include Diagram" checked={includeDiagram} onChange={() => setIncludeDiagram(!includeDiagram)} />
...
function Toggle({ lable, checked, onChange }) {
  return (
    <div className='flex items-center gap-4 cursor-pointer select-none' onClick={onChange}>
      ...
      <span className={`text-sm tranistion-colors
