      ...
      <div className="min-h-screen overflow-hidden bg-white text-black px-8">
        ...
        <main className='max-w-7xl items-center mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
            ...
            <Feature icon="📘" title="Projects Notes" description="Well Structured documentation and assignments & project" />
            <Feature icon="📂" title="Exam notes" description="High-yield, revision-ready exam-oriented notes" />
            <Feature icon="📊" title="Charts & Graphs" description="Auto-generated diagrams, charts and flow graphs" />
            <Feature icon="⬇️" title="Free PDF Download" description="Download clean printalbe PDFs instanly" />
          </div>
        </main>
      </div>
    </>
