...
const markDownComponent = {
  ...
  p: ({ children }) => (
    <p className='text-grey-700 leading-relaxed mb-3'>
      {children}
    </p>
  ),
  ul: ({ children }) => (
...
const FinalResult = ({ result }) => {
  ...
  return (
    <div className='mt-6 p-3 space-y-10 bg-white'>
      ...
      {!quickRevision &&
        <section>
          <SectionHeader icon="🗄️" title="Detailed Notes" color="purple"/>
        ...
        {quickRevision && 
        <section className='rounded-xl bg-gradient-to-r from-green-100 to-green-50 border
        border-green-200-p-6'>
        ...
        <section>
          <SectionHeader icon="❓" title="Important Question" color = "rose"/>
